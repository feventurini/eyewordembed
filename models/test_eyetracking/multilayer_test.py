...
if __name__ == '__main__':
    ...
    model_types = ['multilayer', 'multilayer_context']
    wlens = [True]
    poss = [True, True, False]
    n_pos_unitss = [50, 100, None]
    outs = ['tanh', 'sigmoid']
    n_hiddens = [100, 200]
    n_layerss = [1, 2]
                ...
                for n_hidden in n_hiddens:
                    for n_layers in n_layerss:
                        for n_pos_units, pos in zip(n_pos_unitss, poss):
                            ...
                            name = '{}_len{}_pos{}_posUnits{}_layers{}_hiddenunits{}'.format(out_type, wlen, pos, n_pos_units, n_layers, n_hidden)
