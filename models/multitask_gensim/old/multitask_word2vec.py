...
class MultiTaskWord2Vec(Word2Vec):
     ...
     def _do_train_job(self, sentences, multitask_batch, alpha, inits):
        """
        ...
        self.multitask_optimizer.update(self.multitask_model, x, t)
        #input("Thread: " + str(threading.get_ident()) + " AFTER:\n" + str(self.wv.syn0))
        
        return tally, self._raw_word_count(sentences)

     def train(self, sentences, multitask_dataset, multitask_model, multitask_optimizer, total_examples=None, total_words=None,
        ...
        self.multitask_optimizer = multitask_optimizer
        self.multitask_model.embed.W.data = self.wv.syn0
        ...
        def worker_loop():
            ...
            while True:
                ...
                tally, raw_tally = self._do_train_job(sentences, multitask_batch, alpha, (work, neu1))
