...
if os.path.isfile(args.vocab + os.sep + "init_vocab_" + os.path.basename(dundee) + ".model"):
    model.reset_from(gensim.models.Word2Vec.load(args.vocab + os.sep + "init_vocab_" + os.path.basename(dundee) + ".model"))
else:
    ...
    model.save(args.vocab + os.sep + "init_vocab_" + os.path.basename(dundee) + ".model")

logging.info("Starting training...")
report_delay = 3.0

model_2 = gensim.models.word2vec.Word2Vec(sentences=None)
model_2.reset_from(gensim.models.Word2Vec.load(args.vocab + os.sep + "init_vocab_" + os.path.basename(train_tarball) + ".model"))

sentences = gensim.models.word2vec.LineSentence(train_tarball)

# word2vec_iter = MultitaskBatchIterator(sentences, args.epoch, model_2.corpus_count, batch_size=args.batchsize, maxsize=5)
...
model.save(args.out + os.sep + "word2vec_gigaword_limit_vocab_" + str(args.unit) + "_" + args.model + "_" + args.out_type + '_' + 
